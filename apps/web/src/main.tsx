...
function App() { return <AuthProvider><Navigation/><Routes><Route path="/" element={<Home/>}/><Route path="/login" element={<AuthPage/>}/><Route path="/market" element={<Placeholder title="商品市场"/>}/><Route path="/products/:id" element={<Placeholder title="商品详情"/>}/><Route path="/workspace/generation" element={<Protected><Placeholder title="AI 工作台"/></Protected>}/><Route path="/me" element={<Protected><Profile/></Protected>}/></Routes></AuthProvider>; }
