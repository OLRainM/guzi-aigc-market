...
import (
	...
	"aigc-3d-platform/apps/api/internal/admin"
...
func main() {
	...
	adminHandler, err := admin.New(db, generationHandler.Service())
	if err != nil {
	...
	adminHandler.RegisterRoutes(api, authHandler.Authenticate())
